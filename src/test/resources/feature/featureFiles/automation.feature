...
@userInShopPage 
Scenario: User should be able to verify the functionality of the buttons on shop page
	...
	@userInContactPage
	Scenario: User should be able to see the contact methods
	...
	@userInCartShop
	Scenario: User should be able to see the payment options
